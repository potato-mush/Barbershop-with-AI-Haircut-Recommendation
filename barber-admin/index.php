...
$complete_data = "complete_appointment_".$row["appointment_id"];
?>

<ul class="list-inline m-0">

    <!-- APPROVE BUTTON -->
    <li class="list-inline-item" data-toggle="tooltip" title="Approve Appointment">
        <button class="btn btn-success btn-sm"
                type="button"
                data-toggle="modal"
                data-target="#<?php echo $complete_data; ?>">
    ...
    <li class="list-inline-item" data-toggle="tooltip" title="Cancel Appointment">
        <button class="btn btn-danger btn-sm"
                type="button"
                data-toggle="modal"
                data-target="#<?php echo $cancel_data; ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"
                        id="appointment_cancellation_reason_<?php echo $row['appointment_id']; ?>"></textarea>
                </div>
            </div>
...
<!-- ================= APPROVE MODAL ================= -->
<div class="modal fade" id="<?php echo $complete_data; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button"
                        data-id="<?php echo $row['appointment_id']; ?>"
                        class="btn btn-success confirm_complete_button">
                    Yes, Approve
                </button>
            </div>
...
?>
<script>
$(document).on('click', '.confirm_complete_button', function(){
...
$(document).on('click', '.cancel_appointment_button', function(){
    ...
    var appointment_id = $(this).data('id');
    var reason = $("#appointment_cancellation_reason_" + appointment_id).val();
